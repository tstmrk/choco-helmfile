...
$url        = 'https://github.com/roboll/helmfile/releases/download/v0.99.1/helmfile_windows_386.exe' # download url, HTTPS preferred
$url64      = 'https://github.com/roboll/helmfile/releases/download/v0.99.1/helmfile_windows_amd64.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'helmfile*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
